#!/bin/bash
# Test script focused on the --no-publish flag for store-dir command
...
# Test store-dir command help to verify flags
run_test "store-dir help" "$PYTHON -m hippius_sdk.cli store-dir -h"

# Test store-dir with different flag combinations
...
# Test with global encryption flags
...
# Check on erasure-code command help (for comparison)
...
echo -e "\n\033[1;32m==== All --no-publish flag tests completed successfully! ====\033[0m"