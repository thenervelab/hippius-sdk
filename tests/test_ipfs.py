...
class TestIPFSClient(unittest.TestCase):
    ...
    def test_upload_file_via_http_api(self, mock_post, mock_connect):
        ...
        mock_connect.side_effect = ipfshttpclient.exceptions.ConnectionError("Connection error")
    ...
    def test_download_file(self, mock_get):
        ...
        with tempfile.NamedTemporaryFile() as output_file:
            ...
            mock_get.assert_called_once_with(f"{self.gateway}/ipfs/QmTest123", stream=True)
    ...
    def test_pin_via_http_api(self, mock_post, mock_connect):
        ...
        # Verify the HTTP request was made
        mock_post.assert_called_once()
        self.assertEqual(mock_post.call_args[0][0], "https://localhost/api/v0/pin/add?arg=QmTest123")
        self.assertTrue(success)
