...
async def test_credits_success(mock_api_class, mock_get_config, mock_client):
...
@patch("hippius_sdk.cli_handlers_file.HippiusApiClient")
async def test_credits_string_balance(mock_api_class, mock_get_config, mock_client):
